defmodule ElixirBetWeb.UserRegistrationLive do
    ...
    <div class="em-gradient flex flex-col items-center justify-center">
        ...
        <div class="mx-auto max-w-sm">
          ...
          >
            ...
            <.input field={@form[:first_name]} type="text" placeholder="First Name" required />
            <.input field={@form[:last_name]} type="text" placeholder="Last Name" required />
            <.input field={@form[:msidn]} type="text" placeholder="Mobile Number" required />
